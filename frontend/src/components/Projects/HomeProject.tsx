...
export default function HomeProject() {
  ...
  return (
    <div className="lg:mt-56 mt-20 flex flex-col gap-10 justify-center">
        <h2 className="text-[64px] font-bold text-center">My Projects <TextHeilight text="Highlight" /></h2>
        <div className="flex justify-center"><Button>View All Works <GrLinkNext /></Button></div>
